                    ...
                    <div class="row">
                        <div class="col-md-6 mx-auto">
                            <form action="{{route('admin.products.update', $product->slug)}}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="color_id[]" id="color_id" multiple
                                        ...
                                        <option value="{{$color->id}}" @if(collect(old('color_id'))->
                                            contains($color->id) || $product->colors->contains($color->id)) selected
                                            @endif
                                            value="{{$color->id}}"
                                            >
                                            {{$color->name}}
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="size_id[]" id="size_id" multiple
                                        ...
                                        <option value="{{$size->id}}" @if(collect(old('size_id'))->contains($size->id)
                                            || $product->sizes->contains($size->id)) selected @endif
                                            value="{{$size->id}}"
                                            >
                                            {{$size->name}}
                                        </option>
                                ...
                                <div class="mt-2">
                                    <img src="{{asset($product->thumbnail)}}" id="thumbnail_preview" class="img-fluid rounded mb-2"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="first_image" name="first_image" type="file"
                                        ...
                                        placeholder="First Image" value="{{old('first_image')}}">
                                    @error('first_image')
                                    <span class="invalid-feedback">
                                        <strong>{{$message}}</strong>
                                    </span>
                                ...
                                <div class="mt-2">
                                    <img src="{{asset($product->first_image)}}" id="first_image_preview" class="@if(!$product->first_image) d-none @endif img-fluid rounded mb-2"
                                        width="100" height="100">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input id="second_image" name="second_image" type="file"
                                        ...
                                        placeholder="Second Image" value="{{old('second_image')}}">
                                    @error('second_image')
                                    <span class="invalid-feedback">
                                        <strong>{{$message}}</strong>
                                    </span>
                                ...
                                <div class="mt-2">
                                    <img src="{{asset($product->second_image)}}" id="second_image_preview" class="@if(!$product->first_image) d-none @endif img-fluid rounded mb-2"
                                        width="100" height="100">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input id="third_image" name="third_image" type="file"
                                        ...
                                        placeholder="Third Image" value="{{old('third_image')}}">
                                    @error('third_image')
                                    <span class="invalid-feedback">
                                        <strong>{{$message}}</strong>
                                    </span>
                                ...
                                <div class="mt-2">
                                    <img src="{{asset($product->third_image)}}" id="third_image_preview" class="@if(!$product->first_image) d-none @endif img-fluid rounded mb-2"
                                        width="100" height="100">
                                </div>
                                <div class="mb-2">
